---
title: "04-统一接口与多厂商适配"
date: "2026-04-28T16:05:54.200Z"
lastUpdated: "2026-04-28T16:05:54.200Z"
description: "在上一篇中，我们了解了 LangChain 1.0 的生态全景和迁移要点。你可能已经注意到，七个核心组件中，Models 是整个框架的入口——Agent 的\"大脑\"就是大语言模型。而不同厂商的模型 API 各不相同——OpenAI 用一种格式，Anthropic 用另一种，Google 又是第三种。..."
---
...
　　　　在上一篇中，我们了解了 LangChain 1.0 的生态全景和迁移要点。你可能已经注意到，七个核心组件中，Models 是整个框架的入口——Agent 的"大脑"就是大语言模型。而不同厂商的模型 API 各不相同——OpenAI 用一种格式，Anthropic 用另一种，Google 又是第三种。如果每次切换模型都要重写适配代码，开发效率将极低。
