...
date: "2026-04-23T09:54:01.024Z"
lastUpdated: "2026-04-23T09:54:01.024Z"
description: "01-从LLM到Agent概念与演进 从 LLM 到 Agent：概念与演进 一、本章导学 　　　　如果你正在阅读这篇文章，大概率已经和 ChatGPT、通义千问、DeepSeek 等 AI 产品聊过天。你可能会问：既然大模型已经这么聪明了，为什么还需要学 Agent？为什么还需要 LangChai..."
---
...
　　注册登录[硅基流动](https://link.juejin.cn/?target=https%3A%2F%2Fcloud.siliconflow.cn%2Fsft-vvfxl38cs4%2Fmodels "https://cloud.siliconflow.cn/sft-vvfxl38cs4/models")官网，并申请API Key用于请求大模型。

![image](assets/image-20260331134241-fx9pfnw-20260423175050-jyx4mur.png)

　　在模型广场搜索`Qwen3-8B`，并复制模型名称

![image](assets/image-20260331134434-bv2nh4t-20260423175109-lg0lru1.png)
...
3. **Token** 是模型处理文本的基本单位，也是计费标准，1000 字中文约消耗 600 个 Token。
